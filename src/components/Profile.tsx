...
export const Profile: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-12">
      <header>
        <h2 className="text-5xl font-medium tracking-tighter text-neu-white uppercase leading-none">User Profile</h2>
        <p className="text-white/40 font-medium uppercase tracking-widest text-xs mt-2">Manage and view your account information.</p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        >
          ...
          <div className="w-40 h-40 rounded-[2.5rem] bg-orange-gradient flex items-center justify-center text-neu-white text-5xl font-medium mb-8 shadow-2xl shadow-neu-orange/40 group-hover:scale-105 transition-transform duration-500">
          ...
          <div className="w-full pt-8 border-t border-white/5">
            <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-neu-orange/20 text-neu-orange text-[10px] font-medium uppercase tracking-widest border border-neu-orange/30">
              <Shield size={16} />
              {profile.role}
            </div>
          </div>
        ...
        >
          <h3 className="text-2xl font-medium mb-12 flex items-center gap-3 text-neu-white uppercase tracking-tighter">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
            {infoItems.map((item) => (
              <div key={item.label} className="space-y-2 group">
                <p className="text-[10px] text-white/20 font-medium uppercase tracking-widest flex items-center gap-3 group-hover:text-white/40 transition-colors">
          ...
          {profile.role === 'faculty' && (
            <div className="mt-12 p-8 bg-white/5 rounded-[2rem] border border-white/5 relative overflow-hidden">
              ...
              <h4 className="font-medium text-neu-white mb-4 uppercase text-xs tracking-widest flex items-center gap-2">
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="text-sm text-white/60 font-medium uppercase tracking-tighter">
